      ...
      <LandingStyle className="h-[88%] flex justify-between flex-col lg:flex-row lg:mt-2 mt-8">
        <div className="lg:w-1/2 w-[100%] h-full flex justify-center flex-col px-5 lg:pl-16 lg:pr-8 ">
          <p className="text-gray-50 text-xl tracking-widest">
            Chase The Best Flavour
          </p>
          <img src={spoon} alt="spoon" className="w-[50px] mb-5" />
          <h1 className="text-yel text-8xl w-[100%] lg:w-[110%] xl:w-[80%]">
          Unlocking the Secrets of Exquisite Dining
          </h1>
          
          <p className="text-gray-50 capitalize mt-10 tracking-wider">
            Welcome to our eatery,
            <span className="text-yel uppercase">FlavorJunction</span>, where
            savoring fresh and nutritious meals is a delight. Our skilled chef
            meticulously selects top-quality ingredients to craft delectable
            dishes that cater to every palate. With the convenience of both online
            ordering and dine-in services, relish our cuisine however you prefer.
          </p>
          <Link
            to={"/menu"}
